...
x7b
length(x7b)
z=seq(10,100,along.with=x7a)
t= seq(from=10, to=30, lenght.out=10)
x15 = seq(from=10, to=20, length.out=5)
t#multiple functions-------
...
d2=c('a','b','c')
d2
d2a=sample(x=d2,size=100,replace=T, prob=c(0.1,0.6,0.3))
d2a
table(d2a)
prop.table(table(d2a))
# Male % approx 60%
