...
#vector ----
(v1 = 1:24) # assigning as well as printing

dim(v1) # dimesion of an object
attributes(v1) # just like height, age and gender
class(v1)
...
attributes(m1)  #properties necessary attribute is 
?attributes
...
m3
t(m3)  #transpose
sweep(m3, MARGIN=1, STATS=c(2,3,4,5,6,7), FUN='+')  #row + x do it row wise and values are sucha dnsuch and fucnin is plus
